...
import 	com.apps.util.Prompter; import java.util.Scanner;
...
/*	Prompter prompter = new Prompter(new Scanner(System.in));
	...
	public String mainMenu(){};
		...
		public final String loadScreen = (String.format("Hello %s! Are you ready to play Big Tech? or Small Package?" + " Enter (Y) to begin or (Q) to exit the game.", getName()));
